...
import { ChatMessage } from "../src/AImelia/AImelia";
...
app.post("/createMessage", async (req, res) => {
  try {
    ...
    const getMessages = () => {
      messages.unshift({ message: "Hello", from: "user" });
